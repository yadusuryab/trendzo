  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        >
          <motion.div
            className="p-3 rounded-xl bg-gradient-to-br from-amber-500 to-yellow-500 text-white shadow-lg"
...
function LuxuryFeature({ icon, title, description }: any) {
  return (
    ...
    >
      <motion.div
        className="p-3 rounded-xl bg-slate-100 text-slate-700 group-hover:bg-amber-100 group-hover:text-amber-600 transition-colors duration-300"
